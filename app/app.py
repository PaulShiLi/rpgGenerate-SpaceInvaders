...
def playground():
    ...
    if request.method == 'POST':
        ...
        if (model=="personality"):
            ...
            ai = aitextgen(model_folder="personality_model/", tokenizer_file="personality_model/aitextgen.tokenizer.json", to_gpu=False)
            ...
            ai = aitextgen(model_folder="backStory_model/", tokenizer_file="backStory_model/aitextgen.tokenizer.json", to_gpu=False)
            ...
            ai = aitextgen(model_folder="physical_Model/", tokenizer_file="physical_Model/aitextgen.tokenizer.json", to_gpu=False)
